...
import { bottonNavOptions, navOptions, otherNavOptions } from "routes/-components/sidebar/consts"
...
export function App() {
  ...
  const { isSidebarHidden } = use(AppContext) //TODO: This should be a global store, zustand probably
